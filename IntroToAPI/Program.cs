...
namespace IntroToAPI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var genericResponse = service.GetAsync<Person>("https://swapi.dev/api/vehicles/4").Result;

            Person genericResponse = service.GetAsync<Person>("https://swapi.dev/api/people/4").Result;
            ...
            var vehicleSearch = service.GetVehicleSearchAsync("speeder");
